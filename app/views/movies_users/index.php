<div id="movies_users" > 
	 <div class="actions-content"> 
		 <button id="js-new" class="js-button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"> 
			 <span class="ui-button-text"><?php echo I18n("new_movies_user");?></span> 
		 </button> 
		 <div class="both"></div> 
	 </div> 
	 <div id="waiting" ></div> 
	 <table id="table-movies_users" class="display ex_highlight_row js-table-sorter"> 
		 <thead> 
			 <tr class="ui-widget-header "> 
				 <th class="column-action"></th> 
				 <th class="column-movie-id"><?php echo I18n("movie_id");?></th> 
				 <th class="column-user-id"><?php echo I18n("user_id");?></th> 
			 </tr> 
		 </thead> 
		 <tbody> 
		 <?php 
		 if($movies_users){ 
			 foreach ($movies_users as $movies_user) { ?> 
				 <tr class="line js-over" > 
					 ...
					 <td class="movie "><?php echo $movies_user->get_movie()->get_id(); ?></td> 
					 <td class="user "><?php echo $movies_user->get_user()->get_id(); ?></td> 
				 </tr> 
			 <?php } 
			 } ?> 
		 </tbody> 
 ...
 <div id="js-message-delete" class="hidden"><?php echo I18n("delete_movies_user");?></div> 
